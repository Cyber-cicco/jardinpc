...
import "github.com/Cyber-cicco/jardin-pc/internal/views/evenements"
...
func InnerHome(evts []*model.Evenement) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<section class=\"flex flex-col h-screen w-full items-center justify-center zoom-in bg-main\"><h1 data-fade-in class=\"font-bold text-center px-3 text-white text-4xl lg:text-6xl\">Bienvenu au jardin Pollen et Collemboles ! </h1><h2 class=\"italic text-white fade-right-1 text-xl lg:text-3xl\">Le jardin partagé du quartier Richolets</h2></section><div class=\"flex flex-col gap-10 w-full\"><section class=\"flex flex-row w-full\"><div class=\"flex flex-col p-2 lg:flex-row justify-center\"><div class=\"flex p-10 justify-end\"><img alt=\"les habitants au travail !\" data-fade-in height=\"500\" width=\"500\" class=\"rounded-xl border-2 border-black\" src=\"/img/travail.jpg\"></div><div class=\"flex flex-col w-full p-2 lg:w-2/3 gap-5 bg-white border-green-400 border-2 shadow-green-400 text-blue-950 shadow-md bg-opacity-35 items-center justify-center rounded-lg\"><h3 data-fade-right class=\"text-center font-bold text-4xl\">Qui sommes-nous ?</h3><div class=\"flex justify-center w-2/3\"><article data-fade-in class=\"flex flex-col w-full lg:w-2/3 gap-2 text-lg text-justify\"><p>Habitants du quartier Richolets à Saint-Herblain, nous avons pris l'initiative de reprendre la main sur le jardin partagé, abandonné depuis quelques temps.</p><p>Notre but ? En faire un lieu d'échange d'animation et de convivialité, un espace vert au milieu des tours en béton. Nous avons donc décider de remettre en état le jardin, pour ensuite pouvoir y mettre en place des animations (gouters, chantiers collectif, plantations, etc.)</p></article></div></div></div></section><section class=\"flex flex-row-reverse w-full\"><div class=\"flex flex-col p-2 lg:flex-row-reverse justify-center\"><div class=\"flex p-10 justify-end\"><img alt=\"photo de maps pour localiser le jardin : 47.21407477563655, -1.6101690670270175\" data-fade-in height=\"500\" width=\"500\" class=\"rounded-xl border-2 border-black\" src=\"/img/localisation.png\"></div><div class=\"flex flex-col w-full p-2 lg:w-2/3 gap-5 bg-white border-green-400 border-2 shadow-green-400 text-blue-950 shadow-md bg-opacity-35 items-center justify-center rounded-lg\"><h3 data-fade-left class=\"text-center font-bold text-4xl\">Comment nous rejoindre ?</h3><div class=\"flex justify-center w-2/3\"><article data-fade-in class=\"flex flex-col w-full lg:w-2/3 gap-2 text-lg text-justify\"><p>Pour nous rejoindre, rien de plus simple !</p><p>Il vous suffit simplement de venir au jardin à une date où un événement est prévu. <bold>Et pas besoin d'avoir la main verte !</bold> Les personnes déjà présentes s'assurent de la transmission des compétences. Regardez simplement les événements à venir sur ce site, ou <bold>suivez notre page instagram / facebook pour ne rien manquer</bold>.</p></article></div></div></div></section></div><div class=\"p-10\"></div><div class=\"flex justify-center w-full\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
